...
{
    int error = 0;//CheckEEPROMValid(eeData);

    ESP_LOGE(TAG, "starting to extract parameters\nerror is : %d\n", error);

    if(error == 0)
    {
        ExtractVDDParameters(eeData, mlx90640);
        //printf("extracted VDDParameters\n");
        ExtractPTATParameters(eeData, mlx90640);
        //printf("extracted PTATParameters\n");
        ExtractGainParameters(eeData, mlx90640);
        //printf("extracted GainParameters\n");
        ExtractTgcParameters(eeData, mlx90640);
        //printf("extracted TgcParameters\n");
        ExtractResolutionParameters(eeData, mlx90640);
        //printf("extracted ResolutionParameters\n");
        ExtractKsTaParameters(eeData, mlx90640);
        //printf("extracted KsTaParameters\n");
        ExtractKsToParameters(eeData, mlx90640);
        //printf("extracted KsToParameters\n");
        ExtractAlphaParameters(eeData, mlx90640);
        //printf("extracted AlphaParameters\n");
        ExtractOffsetParameters(eeData, mlx90640);
        //printf("extracted OffsetParameters\n");
        ExtractKtaPixelParameters(eeData, mlx90640);
        //printf("extracted KtaPixelParameters\n");
        ExtractKvPixelParameters(eeData, mlx90640);
        //printf("extracted KvPixelParameters\n");
        ExtractCPParameters(eeData, mlx90640);
        //printf("extracted CPParameters\n");
        ExtractCILCParameters(eeData, mlx90640);
        //printf("extracted CILCParameters\n");
        error = ExtractDeviatingPixels(eeData, mlx90640);
        //printf("extracted DeviatingPixels\n");  
    }
    else
    {
