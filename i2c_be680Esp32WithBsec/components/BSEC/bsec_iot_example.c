...
{   
    ...
    ret = bsec_iot_init(BSEC_SAMPLE_RATE_LP, 0.0f, bus_write, bus_read, sleepp, state_load, config_load);
    ...
    bsec_iot_loop(sleepp, esp_timer_get_time, output_ready, state_save, 10000);
